    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div className=''>
                ...
                <p className='my-6 text-[15px] text-gray-500'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.  <br className='max-sm:hidden' /> qui soluta quisquam minima quasi tenetur na</p>
                <div>
                    ...
                    <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700' htmlFor="upload1">
                        ...
                        <p className='text-white text-sm'>Upload Ur Image</p>
                    </label>
                </div>
            </div>
